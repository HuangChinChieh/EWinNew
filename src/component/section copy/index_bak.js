...
const Section_li = (props) =>{
   ...
   className='li-box'
>
   {/* <span className={`${props.favo && props.favo.includes(props.tableInfo.TableNumber) ? 'has-favorites' : ''}`} /> */}
   ...
   <div className={`hover-box ${hoveredItem === props.tableInfo.TableNumber ? 'visible' : ''} ${moreScale}`}>
       ...
       <div className='info-box'>
           ...
           <div className='game-start' >
               ...
               <Link to={`/games/${props.tableInfo.TableNumber}`} onClick={getGameName(props.tableInfo.TableNumber, props.tableInfo.TableTimeoutSecond)}>{t("Global.start_games")}</Link>
           </div>
           ...
           <div className='favorites-box'>
               ...
               <span onClick={() => handleClick(props.tableInfo.TableNumber)} className={`${props.favo && props.favo.includes(props.tableInfo.TableNumber) ? 'remove-to-favorites' : 'add-to-favorites'}`} />
